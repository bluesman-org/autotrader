...
class TradingViewAlertServiceTest {
    ...
    void getAlertsByBotId_shouldReturnAlertsForBot() {
        // Arrange
        List<TradingViewAlert> alerts = Arrays.asList(testAlert);
        ...
        assertEquals(TEST_ALERT_ID, result.get(0).getId());
    ...
    void getAlertsByBotIdAndTimeRange_shouldReturnAlertsForBotAndTimeRange() {
        ...
        assertEquals(TEST_ALERT_ID, result.get(0).getId());
        assertEquals(TEST_BOT_ID, result.get(0).getBotId());
        assertEquals(TEST_TIMESTAMP, result.get(0).getTimestamp());
